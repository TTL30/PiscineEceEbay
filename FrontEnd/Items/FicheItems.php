                        ...
                        <div id="test">
                            ...
                            <div class="row" id="descript">
                                ...
                                <div class="col-sm-12" style="height:10%;text-align:center">
                                    <h2><span class="badge badge-success"><?php echo $infoItem[5] ?>€</span></h2>
                                    <form method="post">
                                        <button type="submit" class="btn my-2 my-sm-0" name="add" value="add" style="float:right;float:bottom;background-color:#dddfe6; display : <?php echo $showButAddPanier ?>">Ajouter au panier</button>
