    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <div class="btn-top" style="margin-left:6%">
                        <nav class="nav" >
                            ...
                            <a id="lien" class="nav-link active" href="AdminVendeurs.php">Liste des vendeurs</a>
                        </nav>
                    </div>
                    <div class="container">
        ...
        <div class="Wrapper-VM">
            <div class="vertical-menu">
                <a href="#" class="active"><strong style="color:white">Vendeurs</strong></a>
            </div>
        </div>
        <div class="listItems">
            <table class="table">
